        ...
        return [
            ...
            'fragebogen' => [
                ...
                'daten' => [
                    ...
                    'branche'     => 'laden',
                    'branche__frei' => 'Panetteria e pasticceria',
                    ...
                    'zielgruppe'  => 'privat,einheim,touristen,stamm',
                    'ort'         => 'Aragona (AG)',
                    'gebiet'      => 'provinz',
                    'ansprech'    => 'Salvatore Marino, titolare',
                    'entscheider' => 'selbst',
                    'ziel1'       => 'gefunden',
                    'ziel2'       => 'besuch',
                    'einesache'   => 'Pane fatto ogni mattina nel forno a legna, non industriale.',
                    'heute'       => 'Rispondiamo al telefono, ma spesso siamo al forno e non lo sentiamo.',
                    'suchwoerter' => "panetteria aragona\npane fresco aragona\nforno a legna vicino a me",
                    'seiten'      => "Home\nI nostri prodotti\nIl forno e la storia\nDove siamo\nContatti",
                    'altseite'    => 'social',
                    'stil'        => 'boden',
                    'farben'      => 'erde,orange',
                    'wirkung'     => 'echt,freundlich,vertrauen',
                    'schriften'   => 'egal',
                    'logo'        => 'ueber',
                    'material'    => 'logo:haben,betrieb:haben,produkt:haben,team:kommt,video:nein,texte:du,preise:haben,zeiten:haben,stimmen:nein',
                    'texte'       => 'du',
                    'bildrechte'  => 'fotograf',
                    'anrede'      => 'du',
                    'klang'       => 'herzlich',
                    ...
                    'telefon'     => '0922 000001',
                    'zeiten'      => 'pause',
                    'zeiten__frei'=> 'Lun–Sab 06:00–13:30 e 17:00–20:00, domenica mattina',
                    'domain'      => 'neu',
                    'wunsch1'     => 'panificiomarino.it',
                    'wunsch2'     => 'panificio-marino.it',
                    'wunsch3'     => 'marinoaragona.it',
                    'karte'       => 'ja',
                    'termin'      => 'keins',
                    'pflege'      => 'du',
                ],
        ...
        return [
            ...
            'fragebogen' => [
                ...
                'daten' => [
                    ...
                    'zielgruppe'  => 'privat,touristen,familien,stamm',
                    'ort'         => 'Sciacca (AG)',
                    'gebiet'      => 'welt',
                    'ansprech'    => 'Anja Berger, Inhaberin',
                    'entscheider' => 'zusammen',
                    'entscheider__frei' => 'Mein Mann entscheidet bei Preisen mit.',
                    'ziel1'       => 'buchungen',
                    'ziel2'       => 'anfragen',
                    'einesache'   => 'Man bucht bei uns direkt, ohne Portal und ohne Provision.',
                    'heute'       => 'Anfragen kommen per WhatsApp, wir antworten meist am selben Tag.',
                    'mitbewerber' => "casavacanzesciacca.it\nEin paar Portale (Booking, Airbnb) mit denselben Häusern",
                    'suchwoerter' => "ferienhaus sciacca\nferienwohnung sizilien meer\nurlaub sciacca privat",
                    'seiten'      => "Startseite\nDie drei Häuser (je eine Seite)\nUmgebung und Ausflüge\nPreise und Belegung\nAnfrage\nAnreise",
                    'sprachen_welche' => 'de,it',
                    'sprache_erst'=> 'de',
                    'altseite'    => 'ja',
                    'altseite__frei' => 'berger-ferienhaeuser.de',
                    'erhalten'    => 'Die Fotos und die Beschreibungen der Häuser.',
                    'stoert'      => 'Auf dem Handy ist sie kaum zu bedienen, und der Kalender stimmt nie.',
                    'stil'        => 'ruhig',
                    'farben'      => 'erde,gruen',
                    'wirkung'     => 'ruhig,hochwertig,vertrauen',
                    'schriften'   => 'egal',
                    'logo'        => 'vektor',
                    'vorbilder'   => 'Uns gefallen ruhige Seiten mit großen Bildern und wenig Text.',
                    'material'    => 'logo:haben,betrieb:haben,produkt:haben,team:nein,video:nein,texte:haben,preise:haben,zeiten:nein,stimmen:kommt',
                    'texte'       => 'teils',
                    'bildrechte'  => 'ja',
                    'anrede'      => 'sie',
                    'klang'       => 'herzlich',
                    'social'      => 'Instagram: @berger.ferienhaeuser',
                    'telefon'     => '+49 170 0000002 (auch WhatsApp)',
                    'zeiten'      => 'keine',
                    'domain'      => 'uns',
                    'domain__frei'=> 'berger-ferienhaeuser.de — würden wir umziehen',
                    'karte'       => 'nein',
                    'termin'      => 'saison',
                    'termin__frei'=> 'Vor Ostern, die Saison beginnt im Mai.',
                    'pflege'      => 'ich',
                    'sonstiges'   => 'Die Übersetzung ins Italienische fehlt noch.',
                ],
            ],
            'website' => [
                'felder' => [
