...
(function () {
  const L = {
    legal: {
      ...
      p9: "If you arrive through one of our partners’ links (vecom-design.it/p/…), we count the click without your IP address and, for the duration of your visit, store a cookie containing the partner’s code; it holds nothing about you and is deleted when you close your browser. If you become a customer, we record which partner you came through so that we can pay their commission. The partner learns neither your name nor any other data about you — only that a purchase took place and its amount. The legal basis is our legitimate interest in settling accounts correctly with our partners (Art. 6(1)(f) GDPR). Anyone applying as a partner sends us their name, email and the optional details in the form; these are used to assess the application and for payouts. Payouts are made via Stripe Payments Europe Ltd. (Ireland); partners enter their bank details there themselves, and we never see them.",
      p7h: "Your rights",
