...
const TEXTE = {
  ...
  it: {
    ...
    h: {
      ueber: (w, cm) => `${w}: ${cm} cm di troppo — scegli un mobile più stretto o toglilo.`,
      rest: (w, cm) => `${w}: ${cm} cm liberi — aggiungi un mobile stretto o un compensatore.`,
      ...
      kochHoch: 'Piano cottura accanto a una colonna — prevedi 30 cm di distanza.',
      kochWand: 'Piano cottura contro il muro — lascia 30 cm di lato.',
