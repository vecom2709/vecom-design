...
const T = {
  ...
  it: { kicker: 'Esempio · così lo vedono i suoi clienti', tag: 'Giorno', zeit: 'Ora', senden: 'Invia richiesta', zurueck: 'Indietro',
    eingang: 'Così le arriva', neu: 'Nuova richiesta dal suo sito', gerade: 'adesso', bestaetigen: 'Conferma', vorschlagen: 'Proponi un altro orario',
