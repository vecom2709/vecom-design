...
const T = {
  de: {
    ...
    keine: 'aus',
    dein: (s, g) => `Ihr Gerät bekommt ${s}${g ? ` — ${g}` : ''}.`,
    gewaehlt: (s) => `Von Ihnen gewählt: ${s}.`,
    ...
    koennteKopf: 'Ihre Website könnte:',
    ...
    branchen: {
      immobilien: {
        ...
        titel: 'Ihre Interessenten gehen durchs Haus, bevor sie anrufen.',
      ...
      architektur: {
        ...
        titel: 'Ihr Bauherr steht im Haus, bevor der erste Stein liegt.',
      ...
      hotel: {
        ...
        titel: 'Ihr Gast erlebt den Abend auf der Terrasse, bevor er bucht.',
      ...
      gastro: {
        ...
        titel: 'Ihr Gast weiß, wo er sitzt, bevor er reserviert.',
      ...
      automotive: {
        ...
        titel: 'Ihr Kunde stellt sein Auto zusammen, bevor er zur Probefahrt kommt.',
      ...
      ecommerce: {
        ...
        titel: 'Ihr Kunde dreht das Produkt, bevor er es kauft.',
      ...
      handwerk: {
        ...
        kann: ['in unter zwei Sekunden am Telefon dastehen', 'Anruf, WhatsApp und Weg immer im Daumenbereich zeigen', 'mit dezenter Bewegung führen statt ablenken', 'bei Google für Ihre Leistungen und Ihren Ort gefunden werden'],
      ...
      industrie: {
        ...
        titel: 'Ihre Maschine erklärt sich selbst.',
  ...
  it: {
    ...
    ansichten: { stand: 'Foto', grundriss: 'Pianta', bau: 'Costruzione', gehen: 'Visita interna' },
    kennungAnsicht: (r, s, a) => `Tempo reale · ${r} · livello ${s} · ${a}`,
    kehrt: 'Lasci andare — la camera torna alla foto',
    ...
    bewegen: 'Rotazione libera',
    zumFoto: 'Torni alla foto',
    leinwand: 'La villa in tempo reale — trascini o usi le frecce per girarla',
    stufeNamen: { SAFE: 'ECO', LOW: 'STANDARD', MEDIUM: 'STANDARD', HIGH: 'HIGH', ULTRA: 'ULTRA' },
    messen: 'misurazione in corso …',
    keine: 'spenta',
    dein: (s, g) => `Il suo dispositivo riceve ${s}${g ? ` — ${g}` : ''}.`,
    gewaehlt: (s) => `Scelto da Lei: ${s}.`,
    ...
    koennteKopf: 'Il suo sito potrebbe:',
    ...
    branchen: {
      immobilien: {
        ...
        titel: 'I suoi clienti entrano in casa prima di telefonare.',
      ...
      architektur: {
        ...
        titel: 'Il suo committente entra in casa prima che si posi la prima pietra.',
      ...
      hotel: {
        ...
        titel: 'Il suo ospite vive la sera in terrazza prima di prenotare.',
        kann: ['mostrare camere, terrazza e giardino prima della prenotazione', 'passare dal giorno alla sera — l’atmosfera vende per Lei', 'portare alla disponibilità con un tocco', 'restare leggero sul telefono, mostrare di più sul portatile'],
        nicht: ['video che partono da soli con l’audio', 'prezzi visibili solo dopo il modulo'],
      },
      gastro: {
        n: 'Ristorante', u: 'Trattoria, bar, pasticceria',
        titel: 'Il suo ospite sa dove si siederà prima di prenotare.',
      ...
      automotive: {
        ...
        titel: 'Il suo cliente compone la propria auto prima di venire al test drive.',
      ...
      ecommerce: {
        ...
        titel: 'Il suo cliente gira il prodotto prima di comprarlo.',
      ...
      handwerk: {
        ...
        kann: ['aprirsi in meno di due secondi sul telefono', 'tenere chiamata, WhatsApp e percorso sempre sotto il pollice', 'guidare con un movimento discreto invece di distrarre', 'farla trovare su Google per i suoi servizi e la sua zona'],
      ...
      industrie: {
        ...
        titel: 'La sua macchina si spiega da sola.',
...
if (demos) {
  ...
  const BUEHNE = { villa: 'villa', auto: 'branchen', shop: 'branchen', tisch: 'tisch', wein: 'produkt', schmuck: 'produkt', kueche: 'planer', gastro: 'produkt', salon: 'haar', lkw: 'produkt' };
  const AUS_ADRESSE = { wein: 'wein', schmuck: 'schmuck', kueche: 'kueche', kuechenplaner: 'kueche', gastro: 'gastro', salon: 'salon', haarfarben: 'salon', lkw: 'lkw', villa: 'villa', 'demo-villa': 'villa', buehne: 'villa', 'branchen-demo': 'auto', 'bd-auto': 'auto', 'bd-shop': 'shop', tisch: 'tisch', dreh: 'tisch' };
  let offen = null;
