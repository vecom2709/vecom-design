...
if (demos) {
  ...
  const BUEHNE = { villa: 'villa', auto: 'branchen', shop: 'branchen', tisch: 'tisch', wein: 'produkt', schmuck: 'produkt', kueche: 'produkt' };
  const AUS_ADRESSE = { wein: 'wein', schmuck: 'schmuck', kueche: 'kueche', villa: 'villa', 'demo-villa': 'villa', buehne: 'villa', 'branchen-demo': 'auto', 'bd-auto': 'auto', 'bd-shop': 'shop', tisch: 'tisch', dreh: 'tisch' };
  let offen = null;
