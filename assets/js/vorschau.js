...
const BRANCHEN = {
  ...
  kueche:     { bild: 'erlebnis/branchen/kueche-nussbaum.webp', akzent: '#c8a27a' },
...
function seite(art, daten) {
  ...
  s.style.setProperty('--akzent', BRANCHEN[daten.branche].akzent);
...
if (sek) {
  ...
  let ecken = null, gezeigt = false, laden = null;
